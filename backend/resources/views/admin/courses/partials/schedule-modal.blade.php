<div id="scheduleModal" class="fixed inset-0 z-50 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <form id="scheduleForm" onsubmit="handleScheduleSubmit(event)" class="p-6">
                <h3 id="scheduleModalTitle" class="text-lg font-medium text-gray-900 mb-4">Add New Schedule</h3>
                ...
                <div class="mt-5 sm:mt-6 flex justify-end gap-2">
                    ...
                    <button type="submit"
                        ...
                        <span id="scheduleModalAction">Create Schedule</span>
