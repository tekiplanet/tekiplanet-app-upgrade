<div id="rewardTypeModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 hidden">
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6 relative">
        <h3 id="modalTitle" class="text-lg font-semibold mb-4">Create Reward Type</h3>
        <form id="rewardTypeForm" method="POST" action="{{ route('admin.conversion-reward-types.store') }}">
            @csrf
