        ...
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
            <li>
                <ul role="list" class="-mx-2 space-y-1">
                    ...
                    @if($admin->hasRole(AdminRole::FINANCE))
                    <li>
                    ...
                    @if($admin->hasRole(AdminRole::MANAGEMENT) || $admin->isSuperAdmin())
                    <li>
                        <a href="{{ route('admin.workstation.subscriptions.index') }}" 
                           class="{{ request()->routeIs('admin.workstation.subscriptions.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
                        >
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        <a href="{{ route('admin.consulting.bookings.index') }}" 
                           class="{{ request()->routeIs('admin.consulting.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
                        >
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <li>
                        ...
                        class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-400 hover:bg-gray-800 hover:text-white {{ request()->routeIs('admin.coupons.*') ? 'bg-gray-800 text-white' : '' }}">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <!-- File Management System - visible to super admin and admin -->
            @if($admin->hasRole(AdminRole::SUPER_ADMIN) || $admin->hasRole(AdminRole::ADMIN))
            <li>
                <div x-data="{ open: {{ request()->routeIs('admin.file-management.*') || request()->routeIs('admin.file-categories.*') || request()->routeIs('admin.file-settings.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            class="{{ request()->routeIs('admin.file-management.*') || request()->routeIs('admin.file-categories.*') || request()->routeIs('admin.file-settings.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex items-center justify-between w-full rounded-md p-2 text-sm leading-6 font-semibold">
                        <div class="flex gap-x-3">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div x-show="open" class="mt-1 space-y-1" style="display: none;">
                        <a href="{{ route('admin.file-management.index') }}" 
                           class="{{ request()->routeIs('admin.file-management.index') ? 'bg-gray-700' : '' }} text-gray-400 hover:text-white hover:bg-gray-700 group flex gap-x-3 rounded-md p-2 pl-11 text-sm leading-6 font-semibold">
                            Dashboard
                        </a>
                        <a href="{{ route('admin.file-categories.index') }}" 
                           class="{{ request()->routeIs('admin.file-categories.*') ? 'bg-gray-700' : '' }} text-gray-400 hover:text-white hover:bg-gray-700 group flex gap-x-3 rounded-md p-2 pl-11 text-sm leading-6 font-semibold">
                            Categories
                        </a>
                        <a href="{{ route('admin.file-settings.index') }}" 
                           class="{{ request()->routeIs('admin.file-settings.*') ? 'bg-gray-700' : '' }} text-gray-400 hover:text-white hover:bg-gray-700 group flex gap-x-3 rounded-md p-2 pl-11 text-sm leading-6 font-semibold">
                            Settings
                        </a>
                    </div>
                </div>
            ...
            <!-- Settings - visible to super admin and admin -->
            @if($admin->hasRole(AdminRole::SUPER_ADMIN) || $admin->hasRole(AdminRole::ADMIN))
            <li>
                <div x-data="{ open: {{ request()->routeIs('admin.settings.*') || request()->routeIs('admin.currencies.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            class="{{ request()->routeIs('admin.settings.*') || request()->routeIs('admin.currencies.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex items-center justify-between w-full rounded-md p-2 text-sm leading-6 font-semibold">
                        <div class="flex gap-x-3">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.324.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 011.37.49l1.296 2.25a1.125 1.125 0 01-.26 1.431l-1.003.827c-.293.24-.438.613-.431.992a6.759 6.759 0 010 .255c-.007.378.138.75.43.99l1.005.828c.424.35.534.954.26 1.43l-1.298 2.247a1.125 1.125 0 01-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.57 6.57 0 01-.22.128c-.331.183-.581.495-.644.869l-.213 1.28c-.09.543-.56.941-1.11.941h-2.594c-.55 0-1.019-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 01-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 01-1.369-.49l-1.297-2.247a1.125 1.125 0 01.26-1.431l1.004-.827c.292-.24.437-.613.43-.992a6.932 6.932 0 010-.255c.007-.378-.138-.75-.43-.99l-1.004-.828a1.125 1.125 0 01-.26-1.43l1.297-2.247a1.125 1.125 0 011.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.087.22-.128.332-.183.582-.495.644-.869l.214-1.281z" />
                    ...
                    <div x-show="open" class="mt-1 space-y-1" style="display: none;">
                        <a href="{{ route('admin.settings.index') }}" 
                           class="{{ request()->routeIs('admin.settings.*') ? 'bg-gray-700' : '' }} text-gray-400 hover:text-white hover:bg-gray-700 group flex gap-x-3 rounded-md p-2 pl-11 text-sm leading-6 font-semibold">
                            General Settings
                        </a>
                        <a href="{{ route('admin.currencies.index') }}" 
                           class="{{ request()->routeIs('admin.currencies.*') ? 'bg-gray-700' : '' }} text-gray-700 group flex gap-x-3 rounded-md p-2 pl-11 text-sm leading-6 font-semibold">
                            Currency Management
                        </a>
                    </div>
                </div>
            ...
            <!-- Additional Super Admin Menu Items -->
            @if($admin->isSuperAdmin())
            <li>
            ...
            <li>
                <a href="{{ route('admin.projects.index') }}" 
                   class="{{ request()->routeIs('admin.projects.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
                >
                    <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <li>
                <a href="{{ route('admin.quotes.index') }}" 
                   class="{{ request()->routeIs('admin.quotes.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
                >
                    <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                    </svg>
            ...
            <li>
                <a href="{{ route('admin.services.index') }}" 
                   class="{{ request()->routeIs('admin.services.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
                >
                    <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <li>
                <div x-data="{ open: {{ request()->routeIs('admin.grits.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            class="{{ request()->routeIs('admin.grits.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex items-center justify-between w-full rounded-md p-2 text-sm leading-6 font-semibold">
                        <div class="flex gap-x-3">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div x-show="open" class="mt-1 space-y-1" style="display: none;">
                        <a href="{{ route('admin.grits.index') }}" 
                           class="{{ request()->routeIs('admin.grits.index') ? 'bg-gray-700' : '' }} text-gray-400 hover:text-white hover:bg-gray-700 group flex gap-x-3 rounded-md p-2 pl-11 text-sm leading-6 font-semibold">
                            All GRITs
                        </a>
                        <a href="{{ route('admin.grits.create') }}" 
                           class="{{ request()->routeIs('admin.grits.create') ? 'bg-gray-700' : '' }} text-gray-400 hover:text-white hover:bg-gray-700 group flex gap-x-3 rounded-md p-2 pl-11 text-sm leading-6 font-semibold">
                            Create GRIT
                        </a>
                    </div>
                </div>
