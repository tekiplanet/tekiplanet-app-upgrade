...
<div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4">
    ...
    <nav class="flex flex-1 flex-col">
        <ul role="list" class="flex flex-1 flex-col gap-y-7">
                ...
                <div x-data="{ open: {{ request()->routeIs('admin.settings.*') || request()->routeIs('admin.currencies.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" class="mt-1 space-y-1" style="display: none;">
                        ...
                        <a href="{{ route('admin.currencies.index') }}" 
                           class="{{ request()->routeIs('admin.currencies.*') ? 'bg-gray-700' : '' }} text-gray-400 hover:text-white hover:bg-gray-700 group flex gap-x-3 rounded-md p-2 pl-11 text-sm leading-6 font-semibold">
                            Currency Management
                        </a>
                    </div>
                </div>
            ...
            <li>
                <div x-data="{ open: {{ request()->routeIs('admin.hustles.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open" 
                            class="{{ request()->routeIs('admin.hustles.*') ? 'bg-gray-800 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800' }} group flex items-center justify-between w-full rounded-md p-2 text-sm leading-6 font-semibold">
                        <div class="flex gap-x-3">
                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <div x-show="open" class="mt-1 space-y-1" style="display: none;">
                        <a href="{{ route('admin.hustles.index') }}" 
                           class="{{ request()->routeIs('admin.hustles.index') ? 'bg-gray-700' : '' }} text-gray-400 hover:text-white hover:bg-gray-700 group flex gap-x-3 rounded-md p-2 pl-11 text-sm leading-6 font-semibold">
                            All Hustles
                        </a>
                        <a href="{{ route('admin.hustles.create') }}" 
                           class="{{ request()->routeIs('admin.hustles.create') ? 'bg-gray-700' : '' }} text-gray-400 hover:text-white hover:bg-gray-700 group flex gap-x-3 rounded-md p-2 pl-11 text-sm leading-6 font-semibold">
                            Create Hustle
                        </a>
                    </div>
                </div>
