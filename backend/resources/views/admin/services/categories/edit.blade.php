...
<div class="container px-6 mx-auto">
    ...
    <div class="mt-6">
        <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
            <form action="{{ route('admin.service-categories.update', $serviceCategory) }}" method="POST" x-data="{ loading: false }" @submit="loading = true">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  ...
                                  rows="3"
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"
                                  required>{{ old('description', $serviceCategory->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="icon_name" 
                               id="icon_name"
                               value="{{ old('icon_name', $serviceCategory->icon_name) }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500"
                               required>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" 
                               ...
                               id="is_featured"
                               value="1"
                               {{ old('is_featured', $serviceCategory->is_featured) ? 'checked' : '' }}
                    ...
                    <div class="flex justify-end">
                        <button type="submit"
                            ...
                            <span x-text="loading ? 'Updating...' : 'Update Category'"></span>
                        </button>
                    </div>
                </div>
            </form>
